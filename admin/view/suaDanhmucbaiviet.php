      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="m-8 font-weight-bold text-primary">Sửa danh mục bài viết</h2>
            <ol class="breadcrumb">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="txt_ma_danhmucbaiviet" readonly class="form-control" id="" >
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlInput1">Tên danh mục</label>
                      <input type="text" name="txt_name_danhmucbaiviet" class="form-control" id="" p>
                    </div>
