                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <div class="card">
                                    <div class="card-header  bg-primary">
                                        <strong class="card-title text-light">Chỉnh sửa danh mục</strong>
                                    </div>
                                                ...
                                                <div class="card mb-4">
                                                    <div class="card-body">
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col col-md-10">   <input type="text" name="txt_id"  value="<?php echo $data["cateID"]; ?> " class="form-control" id="txt_userid" ></div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col col-md-2"><label for="user-input">Cate_Name</label></div>
                                                            <div class="col col-md-10">   <input type="text" name="txt_name" value="<?php echo $data["catename"]; ?> " class="form-control" id="txt_username" ></div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col col-md-2"> <label for="email-input">Origin</label></div>
                                                            <div class="col col-md-10"><input type="text" value="<?php echo $data["origin"]; ?> " name="txt_origin" id="txt_email" class="form-control" ></div>
                                                        </div>
                                                        <div>
                                                            <button  name="cate_action" value="cate_edit"  type="submit" class="btn btn-primary">Cập nhật</button>    
                                                        </div>
                                                    </div>
                                            </form>
                                            </tbody>
