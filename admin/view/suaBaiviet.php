                ...
                <div id="content">
                    ...
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h3 class="m-8 font-weight-bold text-primary">Sửa Bài viết</h3>
                            <ol class="breadcrumb">
                                            ...
                                            <div class="card mb-4">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="txt_ma_baiviet" readonly="" class="form-control" id="" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput1">Tiêu đề</label>
                                                        <input type="text" name="txt_tieude_baiviet" class="form-control" id="" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlInput1">Mô tả ngắn</label>
                                                        <input type="text" name="txt_motangan_baiviet" class="form-control" id="" >
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control"  name="txt_mota_baiviet" rows="9"  cols="50"></textarea>
