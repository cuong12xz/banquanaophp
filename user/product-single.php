      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php">Trang Chủ</a></span> <span class="mr-2"><a href="index.php">Sản Phẩm</a></span> <span>Product Single</span></p>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
          	...
          	<p><a href="cart.php" class="btn btn-black py-3 px-5">Thêm vào giỏ</a></p>
    			</div>
    		</div>
    	</div>
    </section>
